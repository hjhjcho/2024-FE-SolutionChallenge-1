...
public class JwtTokenProvider {
    ...
    @Autowired
    private MemberRepository tblMemberRepository;
    ...
    private void saveRefreshToken(Authentication authentication, String refreshToken) {
        ...
        tblMember.updateToken(refreshToken);
        tblMemberRepository.save(tblMember);
    }
...
//            throw new AccessDeniedException("지원되지 않는 JWT 토큰입니다.");
...
//            throw new AccessDeniedException("JWT 토큰이 잘못되었습니다");
    ...
    private Claims parseClaims(String accessToken) {
        try {
            return Jwts.parser().setSigningKey(SECRET_KEY).build().parseClaimsJws(accessToken).getBody();
        } catch (ExpiredJwtException e) {
            return e.getClaims();
        }
    }
